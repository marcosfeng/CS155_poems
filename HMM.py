...
class HiddenMarkovModel:
    ...
    def generate_emission(self, M, state = -1):
        '''
        Generates an emission of length M, with starting state
        as specified. If (default) state=-1, assume that the starting state
